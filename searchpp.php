...
<head>
    ...
    <title>Patek Philippe Search</title>
</head>
<body>
    <!--==================== HEADER ====================-->
            ...
            <form action='Logic/back.php' method="POST">
                  ...
                  <div class="btn-group">
                    ...
                    <select name="model" class="dropdown-menu" aria-labelledby="defaultDropdown" style="width: 100%;">
                      ...
                      <option class="dropdown-item" value="Aquanaut">Aquanaut</option>
                      <option class="dropdown-item" value="Beta 21">Beta 21</option>
                      <option class="dropdown-item" value="Calatrava">Calatrava</option>
                      <option class="dropdown-item" value="Chronograph">Chronograph</option>
                      <option class="dropdown-item" value="Complications">Complications</option>
                      <option class="dropdown-item" value="Ellipse dOr">Ellipse dOr</option>
                      <option class="dropdown-item" value="Gondolo">Gondolo</option>
                      <option class="dropdown-item" value="Hour Glass">Hour Glass</option>
                      <option class="dropdown-item" value="Minute Repeater">Minute Repeater</option>
                      <option class="dropdown-item" value="Nautilus">Nautilus</option>
                      <option class="dropdown-item" value="Neptune">Neptune</option>
                      <option class="dropdown-item" value="Pagoda">Pagoda</option>
                      <option class="dropdown-item" value="Perpetual Calendar">Perpetual Calendar</option>
                      <option class="dropdown-item" value="Travel Time">Travel Time</option>
                      <option class="dropdown-item" value="Twenty~4">Twenty~4</option>
                      <option class="dropdown-item" value="Vintage">Vintage</option>
                      <option class="dropdown-item" value="World Time">World Time</option>
                    </select>
                  </div>
