        ...
        <section class="home" id="home">
            ...
            <form action='Logic/back.php' method="POST">
              ...
              <div class="btn-group">
                    ...
                    <input type="hidden" id="marke" name="marke" value="manufacturerIds=187&">
                    <select name="model" class="dropdown-menu" aria-labelledby="defaultDropdown" style="width: 100%;">
                      ...
                      <option class="dropdown-item" value="Constellation Ladies">Constellation Ladies</a></li>
                      <option class="dropdown-item" value="Constellation Petite Seconde">Constellation Petite Seconde</a></li>
                      <option class="dropdown-item" value="Constellation Men">Constellation Men</a></li>
                      <option class="dropdown-item" value="Constellation Quadra">Constellation Quadra</a></li>
                      <option class="dropdown-item" value="Constellation Quartz">Constellation Quartz</a></li>
                      <option class="dropdown-item" value="De Ville">De Ville</a></li>
                      <option class="dropdown-item" value="De Ville Central Tourbillon">De Ville Central Tourbillon</a></li>
                      <option class="dropdown-item" value="De Ville Co-Axial">De Ville Co-Axial</a></li>
                      <option class="dropdown-item" value="De Ville Hour Vision">De Ville Hour Vision</a></li>
                      <option class="dropdown-item" value="De Ville Ladymatic">De Ville Ladymatic</a></li>
                      <option class="dropdown-item" value="De Ville Prestige">De Ville Prestige</a></li>
                      <option class="dropdown-item" value="De Ville Tresor">De Ville Tresor</a></li>
                      <option class="dropdown-item" value="De Ville X2">De Ville X2</a></li>
                      <option class="dropdown-item" value="Dynamic Chronograph">Dynamic Chronograph</a></li>
                      <option class="dropdown-item" value="Flightmaster">Flightmaster</a></li>
                      <option class="dropdown-item" value="Genève">Genève</a></li>
                      <option class="dropdown-item" value="Globemaster">Globemaster</a></li>
                      <option class="dropdown-item" value="Memomatic">Memomatic</a></li>
                      <option class="dropdown-item" value="Museum">Museum</a></li>
                      <option class="dropdown-item" value="Seamaster">Seamaster</a></li>
                      <option class="dropdown-item" value="Seamaster 120 M">Seamaster 120 M</a></li>
                      <option class="dropdown-item" value="Seamaster 1948">Seamaster 1948</a></li>
                      <option class="dropdown-item" value="Seamaster  300">Seamaster  300</a></li>
                      <option class="dropdown-item" value="Seamaster  Apnea">Seamaster  Apnea</a></li>
                      <option class="dropdown-item" value="Seamaster Aqua Terra">Seamaster Aqua Terra</a></li>
                      <option class="dropdown-item" value="Seamaster Bullhead">Seamaster Bullhead</a></li>
                      <option class="dropdown-item" value="Seamaster DeVille">Seamaster DeVille</a></li>
                      <option class="dropdown-item" value="Seamaster Diver 300 M">Seamaster Diver 300 M</a></li>
                      <option class="dropdown-item" value="Seamaster Planet Ocean">Seamaster Planet Ocean</a></li>
                      <option class="dropdown-item" value="Seamaster Planet Ocean Chronograph">Seamaster Planet Ocean Chronograph</a></li>
                      <option class="dropdown-item" value="Seamaster PloProf">Seamaster PloProf</a></li>
                      <option class="dropdown-item" value="Seamaster Railmaster">Seamaster Railmaster</a></li>
                      <option class="dropdown-item" value="Speedmaster">Speedmaster</option>
                      <option class="dropdown-item" value="Speedmaster 57">Speedmaster 57</option>
                      <option class="dropdown-item" value="Speedmaster Broad Arrow">Speedmaster Broad Arrow</a></li>
                      <option class="dropdown-item" value="Speedmaster Date">Speedmaster Date</option>
                      <option class="dropdown-item" value="Speedmaster Day Date">Speedmaster Day Date</option>
                      <option class="dropdown-item" value="Speedmaster HB-SIA">Speedmaster HB-SIA</option>
                      <option class="dropdown-item" value="Speedmaster Ladies Chronograph">Speedmaster Ladies Chronograph</option>
                      <option class="dropdown-item" value="Speedmaster Mark II">Speedmaster Mark II</option>
                      <option class="dropdown-item" value="Speedmaster Mark III">Speedmaster Mark III</option>
                      <option class="dropdown-item" value="Speedmaster Mark IV">Speedmaster Mark IV</option>
                      <option class="dropdown-item" value="Speedmaster Professional Moonwatch">Speedmaster Professional Moonwatch</option>
                      <option class="dropdown-item" value="Speedmaster Professional Moonwatch Moonphase">Speedmaster Professional Moonwatch Moonphase</option>
                      <option class="dropdown-item" value="Speedmaster Racing">Speedmaster Racing</a></option>
                      <option class="dropdown-item" value="Speedmaster Reduced">Speedmaster Reduced</a></option>
                      <option class="dropdown-item" value="Speedmaster Skywalker X-33">Speedmaster Skywalker X-33</option>
                      <option class="dropdown-item" value="Speedmaster  Spacemaker Z-3">Speedmaster  Spacemaker Z-3</option>
                      <option class="dropdown-item" value="Speedmaster  Split-Seconds">Speedmaster  Split-Seconds</option>
                      <option class="dropdown-item" value="Speedsonic">Speedsonic</option>
                    </select>
