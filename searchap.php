...
<head>
    ...
    <title>Audemars Piguet Search</title>
</head>
<body>
    <!--==================== HEADER ====================-->
            ...
            <form action='Logic/back.php' method="POST">
                  ...
                  <div class="btn-group">
                    ...
                    <select name="model" class="dropdown-menu" aria-labelledby="defaultDropdown" style="width: 100%;">
                      ...
                      <option class="dropdown-item" value="Jules Audemars">Jules Audemars</option>
                      <option class="dropdown-item" value="Millenary">Millenary</option>
                      <option class="dropdown-item" value="Millenary 4101">Millenary 4101</option>
                      <option class="dropdown-item" value="Millenary Chronoghraph">Millenary Chronograph</option>
                      <option class="dropdown-item" value="Millenary Ladies">Millenary Ladies</option>
                      <option class="dropdown-item" value="Promesse">Promesse</option>
                      <option class="dropdown-item" value="Royal Oak">Royal Oak</option>
                      <option class="dropdown-item" value="Royal Oak Chronograph">Royal Oak Chronograph</option>
                      <option class="dropdown-item" value="Royal Oak Day-Date">Royal Oak Day-Date</option>
                      <option class="dropdown-item" value="Royal Oak Dual Time">Royal Oak Dual Time</option>
                      <option class="dropdown-item" value="Royal Oak Jumbo">Royal Oak Jumbo</option>
                      <option class="dropdown-item" value="Royal Oak Lady">Royal Oak Lady</option>
                      <option class="dropdown-item" value="Royal Oak Offshore">Royal Oak Offshore</option>
                      <option class="dropdown-item" value="Royal Oak Offshore Chronograph">Royal Oak Offshore Chronograph</option>
                      <option class="dropdown-item" value="Royal Oak Offshore Chronograph Volcano">Royal Oak Offshore Chronograph Volcano</option>
                      <option class="dropdown-item" value="Royal Oak Offshore Diver">Royal Oak Offshore Diver</option>
                      <option class="dropdown-item" value="Royal Oak Offshore Grand Prix">Royal Oak Offshore Grand Prix</option>
                      <option class="dropdown-item" value="Royal Oak Offshore Lady">Royal Oak Offshore Lady</option>
                      <option class="dropdown-item" value="Royal Oak Offshore Tourbillon Chronograph">Royal Oak Offshore Tourbillon Chronograph</option>
                      <option class="dropdown-item" value="Royal Oak Perpetual Calendar">Royal Oak Perpetual Calendar</option>
                      <option class="dropdown-item" value="Royal Oak Selfwinding">Royal Oak Selfwinding</option>
                      <option class="dropdown-item" value="Royal Oak Tourbillon">Royal Oak Tourbillon</option>
                      <option class="dropdown-item" value="Tradition">Tradition</option>
