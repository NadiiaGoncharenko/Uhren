            ...
            <form action='Logic/back.php' method="POST">
                  ...
                  <div class="btn-group">
                    ...
                    <select  name="model" class="dropdown-menu" aria-labelledby="defaulttDropdown" style="width: 100%;">
                      ...
                      <option class="dropdown-item" value="Aerospace Avantage">Aerospace Avantage</option>
                      <option class="dropdown-item" value="Airwolf">Airwolf</option>
                      <option class="dropdown-item" value="Antares">Antares</option>
                      <option class="dropdown-item" value="Avenger">Avenger</option>
                      <option class="dropdown-item" value="Avenger Seawolf1">Avenger Seawolf1</option>
                      <option class="dropdown-item" value="Avenger Skyland">Avenger Skyland</option>
                      <option class="dropdown-item" value="B-1">B-1</option>
                      <option class="dropdown-item" value="B-2">B-2</option>
                      <option class="dropdown-item" value="Blackbird">Blackbird</option>
                      <option class="dropdown-item" value="Callistino">Callistino</option>
                      <option class="dropdown-item" value="Callisto">Callisto</option>
                      <option class="dropdown-item" value="Chrono Cockpit">Chrono Cockpit</option>
                      <option class="dropdown-item" value="Chronomat">Chronomat</option>
                      <option class="dropdown-item" value="Chronomat Colt">Chronomat Colt</option>
                      <option class="dropdown-item" value="Chronomat Evolution">Chronomat Evolution</option>
                      <option class="dropdown-item" value="Chronomat GMT">Chronomat GMT</option>
                      <option class="dropdown-item" value="Chronospace">Chronospace</option>
                      <option class="dropdown-item" value="Cockpit">Cockpit</option>
                      <option class="dropdown-item" value="Cockpit Lady">Cockpit Lady</option>
                      <option class="dropdown-item" value="Colt">Colt</option>
                      <option class="dropdown-item" value="Colt 36">Colt 36</option>
                      <option class="dropdown-item" value="Colt 44">Colt 44</option>
                      <option class="dropdown-item" value="Colt Automatic">Colt Automatic</option>
                      <option class="dropdown-item" value="Colt Chronograph">Colt Chronograph</option>
                      <option class="dropdown-item" value="Colt Chronograph Automatic#">Colt Chronograph Automatic</option>
                      <option class="dropdown-item" value="Colt GMT">Colt GMT</option>
                      <option class="dropdown-item" value="Colt Lady">Colt Lady</option>
                      <option class="dropdown-item" value="Colt Oceane">Colt Oceane</option>
                      <option class="dropdown-item" value="Colt Quartz">Colt Quartz</option>
                      <option class="dropdown-item" value="Colt Skyracer">Colt Skyracer</option>
                      <option class="dropdown-item" value="Crosswind Racing">Crosswind Racing</option>
                      <option class="dropdown-item" value="Duograph">Duograph</option>
                      <option class="dropdown-item" value="Endurance Pro">Endurance Pro</option>
                      <option class="dropdown-item" value="Galactic">Galactic</option>
                      <option class="dropdown-item" value="Galactic 32">Galactic 32</option>
                      <option class="dropdown-item" value="Galactic">Galactic 36</option>
                      <option class="dropdown-item" value="Headwind">Headwind</option>
                      <option class="dropdown-item" value="Hercules">Hercules</option>
                      <option class="dropdown-item" value="Jupiter Pilot">Jupiter Pilot</option>
                      <option class="dropdown-item" value="Lady J">Lady J</option>
                      <option class="dropdown-item" value="Montbrillant">Montbrillant</option>
                      <option class="dropdown-item" value="Navitimer">Navitimer</option>
                      <option class="dropdown-item" value="Navitimer World">Navitimer World</option>
                      <option class="dropdown-item" value="Pluton">Pluton</option>
                      <option class="dropdown-item" value="Professional">Professional</option>
                      <option class="dropdown-item" value="Shadow Flyback">Shadow Flyback</option>
                      <option class="dropdown-item" value="Skyracer">Skyracer</option>
                      <option class="dropdown-item" value="Starliner">Starliner</option>
                      <option class="dropdown-item" value="Superocean">Superocean</option>
                      <option class="dropdown-item" value="Superocean 42">Superocean 42</option>
                      <option class="dropdown-item" value="Superocean Chronograph II">Superocean Chronograph II</option>
                      <option class="dropdown-item" value="Superocean Heritage">Superocean Heritage</option>
                      <option class="dropdown-item" value="Superocean II 42">Superocean II 42</option>
                      <option class="dropdown-item" value="Superocean Steelfish">Superocean Steelfish</option>
                      <option class="dropdown-item" value="Top Time">Top Time</option>
                      <option class="dropdown-item" value="Transocean">Transocean</option>
                      <option class="dropdown-item" value="Transocean Chronograph">Transocean Chronograph</option>
                      <option class="dropdown-item" value="Windrider">Windrider</option>
                      <option class="dropdown-item" value="Wings Lady">Wings Lady</option>
                    </select>
                  </div>
