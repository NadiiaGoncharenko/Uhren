                ...
                <form action='Logic/back.php' method="POST">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="defaultDropdown"
                            ...
                            style="background-color: rgba(13, 68, 32, 0.836);">
                            Modell
                        </button>
                        <input type="hidden" id="marke" name="marke" value="manufacturerIds=221&">
                        <select name="model" class="dropdown-menu" aria-labelledby="defaultDropdown"
                            style="width: 100%;">
                            ...
                            <option class="dropdown-item" value="Lady-Datejust Pearlmaster">Lady-Datejust Pearlmaster
                            </option>
                            ...
                            <option class="dropdown-item" value="Oyster Perpetual Lady Date">Oyster Perpetual Lady Date
                            </option>
            ...
            <div class="story__container grid">
                <div class="story__data">
                    ...
                    <p class="story__description">
                        Wenn die Zeit alles verändert, dann verändert diese Minute die Dinge wie keine andere. Um
                        Mitternacht wird die Oyster Perpetual Day-Date zu einer Brücke zwischen Vergangenheit und
                        Zukunft, zwischen bereits Erreichtem und dem, was es zu erleben gilt. Seit 1956 wird sie am
                        Handgelenk von Visionären, Virtuosen und Pionieren Zeugin der größten Momente der Geschichte.
                        Menschen, die jeden Tag zu einem Versprechen für die Zukunft machen.
                    </p>
