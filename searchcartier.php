        ...
        <section class="home" id="home">
            ...
            <form action='Logic/back.php' method="POST">
                  ...
                  <div class="btn-group">
                    ...
                    <input type="hidden" id="marke" name="marke" value="manufacturerIds=43&">
                    <select name="model" class="dropdown-menu" aria-labelledby="defaultDropdown" style="width: 100%;">
                      ...
                      <option class="dropdown-item" value="Ballon Bleu">Ballon Bleu</option>
                      <option class="dropdown-item" value="Cougar">Cougar</option>
                      <option class="dropdown-item" value="Panthère">Panthère</option>
                      <option class="dropdown-item" value="Pasha">Pasha</option>
                      <option class="dropdown-item" value="Pasha C">Pasha C</option>
                      <option class="dropdown-item" value="Pasha Seatimer">Pasha Seatimer</option>
                      <option class="dropdown-item" value="Roadster">Roadster</option>
                      <option class="dropdown-item" value="Ronde Croisière de Cartier">Ronde Croisière de Cartier</option>
                      <option class="dropdown-item" value="Ronde de Cartier">Ronde de Cartier</option>
                      <option class="dropdown-item" value="Ronde Solo de Cartier">Ronde Solo de Cartier</option>
                      <option class="dropdown-item" value="Santos">Santos</option>
                      <option class="dropdown-item" value="Santos Demoiselle">Santos Demoiselle</option>
                      <option class="dropdown-item" value="Santos Galbée">Santos Galbée</option>
                      <option class="dropdown-item" value="Tank">Tank</option>
                      <option class="dropdown-item" value="Tank Divan">Tank Divan</option>
                      <option class="dropdown-item" value="Tank Française">Tank Française</option>
                      <option class="dropdown-item" value="Tank Solo">Tank Solo</option>
                      <option class="dropdown-item" value="Tank Vermeil">Tank Vermeil</option>
                      <option class="dropdown-item" value="Tortue">Tortue</option>
                      <option class="dropdown-item" value="Trinity">Trinity</option>
                    </select>
